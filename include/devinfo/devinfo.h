...
#define DEVINFO_KEY_NET_INTERFACE_NAME "hardware.network.interface.name"
#define DEVINFO_KEY_NET_INTERFACE_HW_ADDR "hardware.network.interface.hwAddress"
#define DEVINFO_KEY_NET_INTERFACE_IPV4_ADDR "hardware.network.interface.ipv4Address"
#define DEVINFO_KEY_NET_INTERFACE_NETMASK "hardware.network.interface.netmask"
#define DEVINFO_KEY_NET_INTERFACE_IPV6_ADDR "hardware.network.interface.ipv6Address"
...
#include <devinfo/devinfo_model_command.h>
